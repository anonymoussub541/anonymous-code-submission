...
model_requirements = {
    ...
    "purpose": "Predict label 1 or 0 of 3D medical images",
    "descriptive_requirement": "The input 'pixel_values' represents a rescaled-preprocessed 3D image.",
    "init_parameters": {"base_dim": {"type": "int"}, "model_depth": {"type": "int"},},
    "methods": {
        "forward": {
            "inputs": {
                "pixel_values": {"shape": "(batch_size, 1, 64, 64, 64)", "type": "torch.FloatTensor"},
                "label": {"shape": "(batch_size)", "type": "torch.FloatTensor"},
            },
            "outputs": {
                "logits": {"shape": "(batch_size)", "type": "torch.FloatTensor"},
